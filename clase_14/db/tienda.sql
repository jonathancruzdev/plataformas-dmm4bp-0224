...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 13-11-2024 a las 13:30:20
...
(8, '2024-11-13', 'Muy buena :D', 5, 9, 3);
...
--
ALTER TABLE `fotos`
  ADD CONSTRAINT `fotos_ibfk_1` FOREIGN KEY (`id_producto`) REFERENCES `productos` (`id_producto`) ON DELETE CASCADE ON UPDATE CASCADE;
